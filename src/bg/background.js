...
var brightpearlOrderUrl = ["https://use1.brightpearlapp.com/patt-op.php?scode=invoice*"];
...
var brightpearlExistingCustomerUrl = ["https://use1.brightpearlapp.com/patt-op.php?scode=contact&cID=*"];
chrome.contextMenus.create({
...
var brightpearlNewCustomerUrl = ["https://use1.brightpearlapp.com/patt-op.php?scode=contact&type=customer"];
chrome.contextMenus.create({
...
var brightpearlCustomerUrl = ["https://use1.brightpearlapp.com/patt-op.php?scode=contact*"];
chrome.contextMenus.create({
